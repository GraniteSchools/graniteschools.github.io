...
function(dom,parser,Map,Extent,WebTiledLayer,Measurement,GeometryService){
	parser.parse();
...
esri.config.defaults.geometryService = new esri.tasks.GeometryService("http://205.124.110.162/ArcGIS/rest/services/Geometry/GeometryServer");
	...
	//These are the lists of extents for each school
	var el_list = [
