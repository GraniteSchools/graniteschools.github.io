...
require([
  ...
  var reloLayerFL = new FeatureLayer("http://www2.graniteschools.org/ArcGIS/rest/services/Relos/MapServer/1", {
  ...
  // terLyr = new  WebTiledLayer('https://discover.agrc.utah.gov/login/path/fuel-cola-scoop-canyon/tiles/terrain_basemap/${level}/${col}/${row}',{maxScale: 10001});
  ...
  // overLyr = new WebTiledLayer('https://discover.agrc.utah.gov/login/path/fuel-cola-scoop-canyon/tiles/overlay_basemap/${level}/${col}/${row}',{minScale: 10000});
